...
namespace refatoracao.R46.PreserveWholeObject.antes
{
    ...
    class ICMS
    {
        ...
        public static decimal CalcularValor(NotaFiscal notaFiscal)
        {
            if (notaFiscal.Uf == SAO_PAULO)
            {
                return notaFiscal.ValorProdutos * ICMS_SP_PARA_SP;
            }
            return notaFiscal.ValorProdutos * ICMS_PADRAO;
        }
    }
}
