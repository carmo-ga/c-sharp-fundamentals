...
namespace refatoracao.R55.PullUpConstructorBody.antes
{
    ...
    abstract class Cliente
    {
        ...
        private Cliente(string nome, string logradouro, string numero)
        {
            this.nome = nome;
    ...
    class PessoaFisica : Cliente
    {
        ...
        public PessoaFisica(string nome, string logradouro, string numero, string cpf) : base(nome, logradouro, numero)
        {
            this.cpf = cpf;
        }
    }
    ...
    class PessoaJuridica : Cliente
    {
        ...
        public PessoaJuridica(string nome, string logradouro, string numero, string cnpj) : base(nome, logradouro, numero)
        {
            this.cnpj = cnpj;
        }
    }
