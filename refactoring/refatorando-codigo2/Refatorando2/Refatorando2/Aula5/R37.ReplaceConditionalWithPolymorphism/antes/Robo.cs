...
namespace refatoracao.R37.ReplaceConditionalWithPolymorphism.antes
{
    ...
    {
        public R2D2(double velocidadePadrao, double capacidadeDeCarga, int numeroDeBlocos, bool comArmadura, double potencia) : base(0, velocidadePadrao, capacidadeDeCarga, numeroDeBlocos, comArmadura, potencia)
        {
        }
    ...
    {
        public Wally(double velocidadePadrao, double capacidadeDeCarga, int numeroDeBlocos, bool comArmadura, double potencia) : base(1, velocidadePadrao, capacidadeDeCarga, numeroDeBlocos, comArmadura, potencia)
        {
        }
    ...
    {
        public Baymax(double velocidadePadrao, double capacidadeDeCarga, int numeroDeBlocos, bool comArmadura, double potencia): base(2, velocidadePadrao, capacidadeDeCarga, numeroDeBlocos, comArmadura, potencia)
        {
        }
